 ...
 *
 * Serves two flows:
 *   1. Signup   — if a pending signup exists for this email, complete
 *                 registration in Cognito + DB, then clear pending data.
 *   2. Forgot   — no pending signup; OTP is left in store so /reset-password
 *                 can re-verify it before changing the password.
 */
